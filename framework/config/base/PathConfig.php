...
final class PathConfig
{
    ...
    public static function GetConfig(array $custom_config) : array
    {
        ...
        $def_config['fw_vendors_url']       = $def_config['web_domain'] . $rel_path . "node_modules";
        /** The path to the framework's vendors folder */
        $def_config['fw_vendors_path']       = $def_config['base_path'] . $rel_path . "node_modules";
